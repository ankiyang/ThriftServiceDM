...
interface MyFirstServiceIf {
   ...
   * @return int
   */
  public function multiply($number1, $numbers);
  /**
   * @param string $filename
   * @return int
   * @throws \first\MyError
   */
  public function get_log_size($filename);
}


class MyFirstServiceClient implements \first\MyFirstServiceIf {
  ...
  {
    $args = new \first\MyFirstService_log_args();
  ...
  public function multiply($number1, $numbers)
  {
    $this->send_multiply($number1, $numbers);
    return $this->recv_multiply();
  }

  public function send_multiply($number1, $numbers)
  {
    $args = new \first\MyFirstService_multiply_args();
  ...
  public function recv_multiply()
  {
    ...
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\first\MyFirstService_multiply_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \first\MyFirstService_multiply_result();
  ...
  {
    $args = new \first\MyFirstService_get_log_size_args();
    $args->filename = $filename;
    $bin_accel = ($this->output_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_write_binary');
    if ($bin_accel)
    {
  ...
  {
    $bin_accel = ($this->input_ instanceof TBinaryProtocolAccelerated) && function_exists('thrift_protocol_read_binary');
    if ($bin_accel) $result = thrift_protocol_read_binary($this->input_, '\first\MyFirstService_get_log_size_result', $this->input_->isStrictRead());
    else
    {
      $rseqid = 0;
      $fname = null;
      ...
      $result = new \first\MyFirstService_get_log_size_result();
      $result->read($this->input_);
      $this->input_->readMessageEnd();
    }
    if ($result->success !== null) {
...
class MyFirstServiceProcessor {
  ...
  protected function process_multiply($seqid, $input, $output) {
    ...
    $input->readMessageEnd();
    $result = new \first\MyFirstService_multiply_result();
    $result->success = $this->handler_->multiply($args->number1, $args->numbers);
